...
public class PosInvoiceAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8889698317168221323L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PosInvoiceAvro\",\"namespace\":\"types.avro\",\"fields\":[{\"name\":\"InvoiceNumber\",\"type\":[\"null\",\"string\"]},{\"name\":\"CreatedTime\",\"type\":[\"null\",\"long\"]},{\"name\":\"CustomerCardNo\",\"type\":[\"null\",\"double\"]},{\"name\":\"TotalAmount\",\"type\":[\"null\",\"double\"]},{\"name\":\"NumberOfItems\",\"type\":[\"null\",\"int\"]},{\"name\":\"PaymentMethod\",\"type\":[\"null\",\"string\"]},{\"name\":\"TaxableAmount\",\"type\":[\"null\",\"double\"]},{\"name\":\"CGST\",\"type\":[\"null\",\"double\"]},{\"name\":\"SGST\",\"type\":[\"null\",\"double\"]},{\"name\":\"CESS\",\"type\":[\"null\",\"double\"]},{\"name\":\"StoreID\",\"type\":[\"null\",\"string\"]},{\"name\":\"PosID\",\"type\":[\"null\",\"string\"]},{\"name\":\"CashierID\",\"type\":[\"null\",\"string\"]},{\"name\":\"CustomerType\",\"type\":[\"null\",\"string\"]},{\"name\":\"DeliveryType\",\"type\":[\"null\",\"string\"]},{\"name\":\"DeliveryAddress\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"DeliveryAddressAvro\",\"fields\":[{\"name\":\"AddressLine\",\"type\":[\"null\",\"string\"]},{\"name\":\"City\",\"type\":[\"null\",\"string\"]},{\"name\":\"State\",\"type\":[\"null\",\"string\"]},{\"name\":\"PinCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ContactNumber\",\"type\":[\"null\",\"string\"]}]}]},{\"name\":\"InvoiceLineItems\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"LineItemAvro\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemDescription\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"double\"]}]}}}]}");
  ...
  @Deprecated public types.avro.DeliveryAddressAvro DeliveryAddress;
  @Deprecated public java.util.List<types.avro.LineItemAvro> InvoiceLineItems;
   ...
   */
  public PosInvoiceAvro(java.lang.CharSequence InvoiceNumber, java.lang.Long CreatedTime, java.lang.Double CustomerCardNo, java.lang.Double TotalAmount, java.lang.Integer NumberOfItems, java.lang.CharSequence PaymentMethod, java.lang.Double TaxableAmount, java.lang.Double CGST, java.lang.Double SGST, java.lang.Double CESS, java.lang.CharSequence StoreID, java.lang.CharSequence PosID, java.lang.CharSequence CashierID, java.lang.CharSequence CustomerType, java.lang.CharSequence DeliveryType, types.avro.DeliveryAddressAvro DeliveryAddress, java.util.List<types.avro.LineItemAvro> InvoiceLineItems) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 15: DeliveryAddress = (types.avro.DeliveryAddressAvro)value$; break;
    case 16: InvoiceLineItems = (java.util.List<types.avro.LineItemAvro>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public types.avro.DeliveryAddressAvro getDeliveryAddress() {
   ...
   * @param value the value to set.
   */
  public void setDeliveryAddress(types.avro.DeliveryAddressAvro value) {
   ...
   */
  public java.util.List<types.avro.LineItemAvro> getInvoiceLineItems() {
   ...
   * @param value the value to set.
   */
  public void setInvoiceLineItems(java.util.List<types.avro.LineItemAvro> value) {
    this.InvoiceLineItems = value;
  }

  /**
   * Creates a new PosInvoiceAvro RecordBuilder.
   * @return A new PosInvoiceAvro RecordBuilder
   */
  public static types.avro.PosInvoiceAvro.Builder newBuilder() {
    return new types.avro.PosInvoiceAvro.Builder();
  }

  /**
   * Creates a new PosInvoiceAvro RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new PosInvoiceAvro RecordBuilder
   */
  public static types.avro.PosInvoiceAvro.Builder newBuilder(types.avro.PosInvoiceAvro.Builder other) {
    return new types.avro.PosInvoiceAvro.Builder(other);
  }

  /**
   * Creates a new PosInvoiceAvro RecordBuilder by copying an existing PosInvoiceAvro instance.
   * @param other The existing instance to copy.
   * @return A new PosInvoiceAvro RecordBuilder
   */
  public static types.avro.PosInvoiceAvro.Builder newBuilder(types.avro.PosInvoiceAvro other) {
    return new types.avro.PosInvoiceAvro.Builder(other);
  }

  /**
   * RecordBuilder for PosInvoiceAvro instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PosInvoiceAvro>
    implements org.apache.avro.data.RecordBuilder<PosInvoiceAvro> {
    ...
    private types.avro.DeliveryAddressAvro DeliveryAddress;
    private types.avro.DeliveryAddressAvro.Builder DeliveryAddressBuilder;
    private java.util.List<types.avro.LineItemAvro> InvoiceLineItems;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(types.avro.PosInvoiceAvro.Builder other) {
      super(other);
      ...
      if (other.hasDeliveryAddressBuilder()) {
        this.DeliveryAddressBuilder = types.avro.DeliveryAddressAvro.newBuilder(other.getDeliveryAddressBuilder());
      }
    ...
    /**
     * Creates a Builder by copying an existing PosInvoiceAvro instance
     * @param other The existing instance to copy.
     */
    private Builder(types.avro.PosInvoiceAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.InvoiceNumber)) {
        this.InvoiceNumber = data().deepCopy(fields()[0].schema(), other.InvoiceNumber);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setInvoiceNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearInvoiceNumber() {
      InvoiceNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setCreatedTime(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearCreatedTime() {
      CreatedTime = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setCustomerCardNo(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearCustomerCardNo() {
      CustomerCardNo = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setTotalAmount(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearTotalAmount() {
      TotalAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setNumberOfItems(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearNumberOfItems() {
      NumberOfItems = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setPaymentMethod(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearPaymentMethod() {
      PaymentMethod = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setTaxableAmount(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearTaxableAmount() {
      TaxableAmount = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setCGST(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearCGST() {
      CGST = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setSGST(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearSGST() {
      SGST = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setCESS(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearCESS() {
      CESS = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setStoreID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearStoreID() {
      StoreID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setPosID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearPosID() {
      PosID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setCashierID(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearCashierID() {
      CashierID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setCustomerType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearCustomerType() {
      CustomerType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setDeliveryType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearDeliveryType() {
      DeliveryType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setDeliveryAddress(types.avro.DeliveryAddressAvro value) {
     ...
     * @return This builder.
     */
    public types.avro.DeliveryAddressAvro.Builder getDeliveryAddressBuilder() {
      if (DeliveryAddressBuilder == null) {
        if (hasDeliveryAddress()) {
          setDeliveryAddressBuilder(types.avro.DeliveryAddressAvro.newBuilder(DeliveryAddress));
        } else {
          setDeliveryAddressBuilder(types.avro.DeliveryAddressAvro.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public types.avro.PosInvoiceAvro.Builder setDeliveryAddressBuilder(types.avro.DeliveryAddressAvro.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearDeliveryAddress() {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder setInvoiceLineItems(java.util.List<types.avro.LineItemAvro> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.PosInvoiceAvro.Builder clearInvoiceLineItems() {
    ...
    @Override
    public PosInvoiceAvro build() {
      try {
        PosInvoiceAvro record = new PosInvoiceAvro();
        ...
        if (DeliveryAddressBuilder != null) {
          ...
          record.DeliveryAddress = fieldSetFlags()[15] ? this.DeliveryAddress : (types.avro.DeliveryAddressAvro) defaultValue(fields()[15]);
        }
        record.InvoiceLineItems = fieldSetFlags()[16] ? this.InvoiceLineItems : (java.util.List<types.avro.LineItemAvro>) defaultValue(fields()[16]);
        return record;
      } catch (Exception e) {
