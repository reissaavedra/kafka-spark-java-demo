...
public class LineItemAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8745520422791295674L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"LineItemAvro\",\"namespace\":\"types.avro\",\"fields\":[{\"name\":\"ItemCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemDescription\",\"type\":[\"null\",\"string\"]},{\"name\":\"ItemPrice\",\"type\":[\"null\",\"double\"]},{\"name\":\"ItemQty\",\"type\":[\"null\",\"int\"]},{\"name\":\"TotalValue\",\"type\":[\"null\",\"double\"]}]}");
   ...
   */
  public LineItemAvro(java.lang.CharSequence ItemCode, java.lang.CharSequence ItemDescription, java.lang.Double ItemPrice, java.lang.Integer ItemQty, java.lang.Double TotalValue) {
  ...
  /**
   * Creates a new LineItemAvro RecordBuilder.
   * @return A new LineItemAvro RecordBuilder
   */
  public static types.avro.LineItemAvro.Builder newBuilder() {
    return new types.avro.LineItemAvro.Builder();
  }

  /**
   * Creates a new LineItemAvro RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new LineItemAvro RecordBuilder
   */
  public static types.avro.LineItemAvro.Builder newBuilder(types.avro.LineItemAvro.Builder other) {
    return new types.avro.LineItemAvro.Builder(other);
  }

  /**
   * Creates a new LineItemAvro RecordBuilder by copying an existing LineItemAvro instance.
   * @param other The existing instance to copy.
   * @return A new LineItemAvro RecordBuilder
   */
  public static types.avro.LineItemAvro.Builder newBuilder(types.avro.LineItemAvro other) {
    return new types.avro.LineItemAvro.Builder(other);
  }

  /**
   * RecordBuilder for LineItemAvro instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<LineItemAvro>
    implements org.apache.avro.data.RecordBuilder<LineItemAvro> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(types.avro.LineItemAvro.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing LineItemAvro instance
     * @param other The existing instance to copy.
     */
    private Builder(types.avro.LineItemAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ItemCode)) {
        this.ItemCode = data().deepCopy(fields()[0].schema(), other.ItemCode);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder setItemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder clearItemCode() {
      ItemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder setItemDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder clearItemDescription() {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder setItemPrice(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder clearItemPrice() {
      ItemPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder setItemQty(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder clearItemQty() {
      ItemQty = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder setTotalValue(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.LineItemAvro.Builder clearTotalValue() {
      TotalValue = null;
    ...
    @Override
    public LineItemAvro build() {
      try {
        LineItemAvro record = new LineItemAvro();
