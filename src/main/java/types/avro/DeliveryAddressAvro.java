...
public class DeliveryAddressAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4255301197733138102L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"DeliveryAddressAvro\",\"namespace\":\"types.avro\",\"fields\":[{\"name\":\"AddressLine\",\"type\":[\"null\",\"string\"]},{\"name\":\"City\",\"type\":[\"null\",\"string\"]},{\"name\":\"State\",\"type\":[\"null\",\"string\"]},{\"name\":\"PinCode\",\"type\":[\"null\",\"string\"]},{\"name\":\"ContactNumber\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public DeliveryAddressAvro(java.lang.CharSequence AddressLine, java.lang.CharSequence City, java.lang.CharSequence State, java.lang.CharSequence PinCode, java.lang.CharSequence ContactNumber) {
  ...
  /**
   * Creates a new DeliveryAddressAvro RecordBuilder.
   * @return A new DeliveryAddressAvro RecordBuilder
   */
  public static types.avro.DeliveryAddressAvro.Builder newBuilder() {
    return new types.avro.DeliveryAddressAvro.Builder();
  }

  /**
   * Creates a new DeliveryAddressAvro RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new DeliveryAddressAvro RecordBuilder
   */
  public static types.avro.DeliveryAddressAvro.Builder newBuilder(types.avro.DeliveryAddressAvro.Builder other) {
    return new types.avro.DeliveryAddressAvro.Builder(other);
  }

  /**
   * Creates a new DeliveryAddressAvro RecordBuilder by copying an existing DeliveryAddressAvro instance.
   * @param other The existing instance to copy.
   * @return A new DeliveryAddressAvro RecordBuilder
   */
  public static types.avro.DeliveryAddressAvro.Builder newBuilder(types.avro.DeliveryAddressAvro other) {
    return new types.avro.DeliveryAddressAvro.Builder(other);
  }

  /**
   * RecordBuilder for DeliveryAddressAvro instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeliveryAddressAvro>
    implements org.apache.avro.data.RecordBuilder<DeliveryAddressAvro> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(types.avro.DeliveryAddressAvro.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing DeliveryAddressAvro instance
     * @param other The existing instance to copy.
     */
    private Builder(types.avro.DeliveryAddressAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.AddressLine)) {
        this.AddressLine = data().deepCopy(fields()[0].schema(), other.AddressLine);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder setAddressLine(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder clearAddressLine() {
      AddressLine = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder clearCity() {
      City = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder setState(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder clearState() {
      State = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder setPinCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder clearPinCode() {
      PinCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder setContactNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public types.avro.DeliveryAddressAvro.Builder clearContactNumber() {
      ContactNumber = null;
    ...
    @Override
    public DeliveryAddressAvro build() {
      try {
        DeliveryAddressAvro record = new DeliveryAddressAvro();
